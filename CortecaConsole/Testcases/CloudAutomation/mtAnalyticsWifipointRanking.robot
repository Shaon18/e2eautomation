...
*** Test Cases ***
NWCC_L1_NWCC_specificfeature_Analytics_wifipointranking_masteroftenant_reboot
...
NWCC_L1_NWCC_specificfeature_Analytics_wifipointranking_masteroftenant_coverage
    Open Browser    https://homeconsole1.stg.homewifi.nokia.com/    Chrome
    Maximize Window
    qwebelement.typetext    masteruser    username
    qwebelement.typetext    Masteruser@123    password
...
NWCC_L1_NWCC_specificfeature_Analytics_wifipointranking_masteroftenant_cloud
    Open Browser    https://homeconsole1.stg.homewifi.nokia.com/    Chrome
    Maximize Window
    qwebelement.typetext    masteruser    username
    qwebelement.typetext    Masteruser@123    password
...
NWCC_L1_NWCC_specificfeature_Analytics_wifipointranking_masteroftenant_congestion
    Open Browser    https://homeconsole1.stg.homewifi.nokia.com/    Chrome
    Maximize Window
    qwebelement.typetext    masteruser    username
    qwebelement.typetext    Masteruser@123    password
...
NWCC_L1_NWCC_specificfeature_Analytics_wifipointranking_masteroftenant_noise
    Open Browser    https://homeconsole1.stg.homewifi.nokia.com/    Chrome
    Maximize Window
    qwebelement.typetext    masteruser    username
    qwebelement.typetext    Masteruser@123    password
