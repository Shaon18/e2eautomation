...
Root		= {'ip':'192.168.18.1', \
					'mac':'14-55-B9-6D-64-50', \
					'mac1':'14-55-B9-6D-64-50', \
					'model':'Beacon 19', \
                    'model_L2':'Nokia_Beacon_19', \
					'serial_num':'ALCLEB4B377B', \
					'gui_url':'https://www.webgui.nokiawifi.com', \
					'gui_username':'superadmin', \
					'gui_password':'ujrcU22cCE', \
					'gui_Normal_User':'admin', \
                    'gui_Normal_User_pwd':'3yCs2TD3cM',\
					'gui_NormaUser_pwd':'Bcon4269', \
					'ont_gui_username':'superadmin', \
					'gui_type':'B19', \
                    'bconType':'B19', \
					'ssid_defa_name':'NOKIA-6450', \
					'ssid_defa_password':'3yCs2TD3cM', \
                    'guest_ssid_name':'NOKIA-6450_Guest' , \
					...
					'opid':'ALCL', \
					'unium_port':'8090', \
                    'active_firmware':'3TN00841HJMJ51', \
					'Type': 'AONT', \
					'country_id':'eu', \
					'telnet_port':'22', \
					'telnet_username':'superadmin', \
					'telnet_password':'ujrcU22cCE', \
					'telnet_vtysh':'EAT9OvxUYS+yXblzGrTp9wgDwodIlX/16HHgbp+Rv/0/Iw==', \
					'product_code':'001122', \
				    'TopoDefName':'Nokia WiFi Beacon 19', \
					'defa_frn_name':'Beacon 2 (38-A0-67-92-6D-E1)', \
					'defa_frn_name_gui':'Bridge', \
					'defa_frn_name1':'Kitchen', \
					'udefi_frn_name':'Nokia WiFi Beacon 19 (14-55-B9-6D-64-50)', \
...
Ext1 = {'ip': '192.168.1.67', \
               ...
               'model': 'Beacon 19', \
               'mac': '14-55-B9-6D-63-80)', \
                'model_L2':'Nokia_Beacon_19', \
               'mac1': '14-55-B9-6D-63-80', \
               'TopoDefName': 'Nokia WiFi Beacon 19 (14-55-B9-6D-63-80)', \
               ...
               'defa_frn_name_gui': 'APSN9F9A', \
                'udefi_frn_name': 'Nokia WiFi Beacon 19 (14-55-B9-6D-63-80)', \
               'OUI':'089BB9',\
                'Productclass':'Nokia Wifi Beacon 19'}
...
ssh_login={'ipaddresss':'192.168.18.1',\
           ...
           'password':'ujrcU22cCE',\
           'password2':'ENFsn0WucwEKR/vPH385lqkDTOwZm6EWC3QDTmJhN97M9w=='}
