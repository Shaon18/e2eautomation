...
Root		= {'ip':'192.168.18.1', \
                    ...
                    'gui_Normal_User_pwd':'x6HUC3YXpC',\
					...
					'opid':'ALCL', \
					'unium_port':'8090', \
                    'active_firmware':'3FE49334HJMI44', \
					'Type': 'AONT', \
					'country_id':'eu', \
					'telnet_port':'22', \
					'telnet_username':'superadmin', \
					'telnet_password':'Pf2bSS75X=z3', \
					'telnet_vtysh':'EQIbthadBaAoYOYoMeApbLmVAzryZAawVTQxKmv9tS1MPp8=', \
					'product_code':'001122', \
...
ssh_prompt="[root@Beacon 2: superadmin]# "
...
topologyscpath=currentdirectoryfolder + r"\e2eautomation\LOGS\screenshots"
topology_image=currentdirectoryfolder + r"\e2eautomation\CortecaConsole\InputFiles\Supportingfiles\topology.png"
