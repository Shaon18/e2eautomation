...
Root		= {'ip':'192.168.1.15', \
					...
					'opid':'ALCL', \
					'unium_port':'8090', \
                    'active_firmware':'3FE49334HJMI50', \
					'Type': 'AONT', \
					'country_id':'eu', \
					'telnet_port':'22', \
					'telnet_username':'superadmin', \
					'telnet_password':'3465924118', \
...
ssh_login={'ipaddresss':'192.168.1.15',\
           'username':'superadmin',\
