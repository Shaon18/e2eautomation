...
Root		= {'ip':'192.168.18.1', \
					'mac':'DC-8D-8A-08-F4-C1', \
					'mac1':'DC-8D-8A-08-F4-C1', \
					'router-id':'573785184', \
					'model':'Beacon 1.1', \
                    'model_L2':'Nokia_Beacon_1.1', \
					'serial_num':'ALCLFBF65BF6', \
					'gui_url':'https://www.webgui.nokiawifi.com', \
					'gui_username':'superadmin', \
					'gui_password':'RWj969Y!Ui', \
					...
					'gui_type':'B1.1', \
                    'bconType':'B11', \
					'ssid_defa_name':'NOKIA-F4C1', \
					'ssid_defa_password':'x6HUC3YXpC', \
                    'guest_ssid_name':'NOKIA-F4C1_Guest' , \
...
Ext1 = {'ip': '192.168.1.67', \
               ...
               'defa_frn_name': 'Beacon 1.1 (DC-8D-8A-08-EF-B1)', \
               'defa_frn_name_gui': 'APSN9F9A', \
                'udefi_frn_name': 'Beacon 1.1 (DC-8D-8A-08-EF-B1)', \
               'OUI':'089BB9',\
                'Productclass':'Nokia Wifi Beacon 1.1'}

Ext2 = {'ip': '192.168.1.67', \
               'temp_ip': '192.168.1.67', \
               'gui_url1': 'http://192.168.1.67', \
               'model': 'Beacon 1.1', \
               'mac': 'DC-8D-8A-09-6E-41', \
                'model_L2':'Nokia_Beacon_1.1', \
               'mac1': 'DC-8D-8A-09-6E-41', \
               'TopoDefName': 'Beacon 1.1 (DC-8D-8A-09-6E-41)', \
               'router-id': '3331911904', \
               'serial_num': 'ALCLFBF6638E', \
               'wds_mac': '38-A0-67-92-04-B1', \
               'gui_url': 'http://192.168.1.67', \
               'gui_username': 'AdminGPON', \
               'gui_password': 'Anjsaf722bhV!9fK', \
               ...
               'telnet_vtysh': 'EOCU3sTyVGCJRdWvFhPYbN8IgcgGmSMZdf+nN4Khdq0L', \
               'product_code': 'BCM6846', \
               'defa_frn_name': 'Beacon 1.1 (DC-8D-8A-09-6E-41)', \
               'defa_frn_name_gui': 'APSN9F9A', \
                'udefi_frn_name': 'Beacon 1.1 (DC-8D-8A-09-6E-41)', \
               'OUI':'089BB9',\
                'Productclass':'Nokia Wifi Beacon 1.1'}


# Ext3 = {'ip': '192.168.1.67', \
#                'temp_ip': '192.168.1.67', \
#                'gui_url1': 'http://192.168.1.67', \
#                'model': 'Beacon 1.1', \
#                'mac': 'DC-8D-8A-09-2B-01', \
#                 'model_L2':'Nokia_Beacon_1.1', \
#                'mac1': 'DC-8D-8A-09-2B-01', \
#                'TopoDefName': 'Beacon 1.1 (DC-8D-8A-09-2B-01)', \
#                'router-id': '3331911904', \
#                'serial_num': 'ALCLFBF65F5A', \
#                'wds_mac': '38-A0-67-92-04-B1', \
#                'gui_url': 'http://192.168.1.67', \
#                'gui_username': 'AdminGPON', \
#                'gui_password': 'Anjsaf722bhV!9fK', \
...
#                'telnet_vtysh': 'EOCU3sTyVGCJRdWvFhPYbN8IgcgGmSMZdf+nN4Khdq0L', \
#                'product_code': 'BCM6846', \
#                'defa_frn_name': 'Beacon 1.1 (DC-8D-8A-09-2B-01)', \
#                'defa_frn_name_gui': 'APSN9F9A', \
#                 'udefi_frn_name': 'Beacon 1.1 (DC-8D-8A-09-2B-01)', \
#                'OUI':'089BB9',\
#                 'Productclass':'Nokia Wifi Beacon 1.1'}
...
ssh_login={'ipaddresss':'192.168.18.1',\
           ...
           'password':'RWj969Y!Ui',\
           'password2':'EQFkqaQUcnKSSI6S/xrQyszsAuoDz4i9OgcESZRmtqvhQts='}
