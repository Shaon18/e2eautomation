...
Root		= {'ip':'192.168.18.1', \
					...
					'telnet_vtysh':'EINenDEIM46o4izfOUge/lkB0RsjF12Z5Ecr0x6bwp4fvg==', \
...
Ext1 = {'ip': '192.168.18.4', \
               'temp_ip': '192.168.18.4', \
               'gui_url1': 'http://192.168.18.4', \
               'model': 'Beacon 1.1', \
