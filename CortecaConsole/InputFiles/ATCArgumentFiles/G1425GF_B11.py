...
Root		= {'ip':'192.168.1.1', \
					'mac':'D8-B0-20-85-C8-30', \
					'mac1':'D8-B0-20-85-C8-30', \
					'router-id':'573785184', \
					'model':'G-1425G-F', \
                    'model_L2':'G-1425G-F', \
					'serial_num':'ALCLEB467B10', \
					...
					'ont_gui_username':'admin', \
					'gui_type':'B2', \
                    'bconType':'G1425GF', \
					'ssid_defa_name':'Airtel_Zerotouch', \
					'ssid_defa_password':'Airtel@123', \
                    'guest_ssid_name':'Airtel_Zerotouch_Guest' , \
...
Ext1 = {'ip': '192.168.1.67', \
               ...
               'model': 'Beacon 1.1', \
               'mac': 'E0-1F-2B-B7-D6-C1', \
                'model_L2':'NOKIA_BEACON_1.1', \
               'mac1': 'E0-1F-2B-B7-D6-C1', \
               'TopoDefName': 'Beacon 1.1 (E0-1F-2B-B7-D6-C1)', \
               'router-id': '3331911904', \
               'serial_num': 'ALCLFC3832E9', \
               ...
               'bconType': 'B11', \
                'opid': 'NKBB', \
               'unium_port': '8090', \
               'active_firmware':'3FE49474HJMI64', \
               'country_id': 'eu', \
               'telnet_port': '23', \
               ...
               'defa_frn_name': 'Beacon 1.1 (E0-1F-2B-B7-D6-C1)', \
               'defa_frn_name_gui': 'APSN9F9A', \
                'udefi_frn_name': 'Beacon 1.1 (E0-1F-2B-B7-D6-C1)', \
               'OUI':'089BB9',\
...
Ext2 = {'ip': '192.168.1.67', \
               ...
               'gui_url1': 'http://192.168.1.67', \
               'model': 'Beacon 1.1', \
               'mac': 'E0-1F-2B-B7-D8-B1', \
                'model_L2':'NOKIA_BEACON_1.1', \
               'mac1': 'E0-1F-2B-B7-D8-B1', \
               'TopoDefName': 'Beacon 1.1 (E0-1F-2B-B7-D8-B1)', \
               'router-id': '3331911904', \
               'serial_num': 'ALCLFC383308', \
               'wds_mac': '38-A0-67-92-04-B1', \
               'gui_url': 'http://192.168.1.67', \
               'gui_username': 'AdminGPON', \
               'gui_password': 'Anjsaf722bhV!9fK', \
               ...
               'telnet_vtysh': 'EOCU3sTyVGCJRdWvFhPYbN8IgcgGmSMZdf+nN4Khdq0L', \
               'product_code': 'BCM6846', \
               'defa_frn_name': 'Beacon 1.1 (E0-1F-2B-B7-D8-B1)', \
               'defa_frn_name_gui': 'APSN9F9A', \
                'udefi_frn_name': 'Beacon 1.1 (E0-1F-2B-B7-D8-B1)', \
               'OUI':'089BB9',\
                'Productclass':'Nokia Wifi Beacon 2'}
...
Ext3 = {'ip': '192.168.1.67', \
               ...
               'gui_url1': 'http://192.168.1.67', \
               'model': 'Beacon 1.1', \
               'mac': 'E0-1F-2B-B8-B3-41', \
                'model_L2':'NOKIA_BEACON_1.1', \
               'mac1': 'E0-1F-2B-B8-B3-41', \
               'TopoDefName': 'Beacon 1.1 (E0-1F-2B-B8-B3-41)', \
               'router-id': '3331911904', \
               'serial_num': 'ALCLFC3840B1', \
               'wds_mac': '38-A0-67-92-04-B1', \
               'gui_url': 'http://192.168.1.67', \
               'gui_username': 'AdminGPON', \
               'gui_password': 'Anjsaf722bhV!9fK', \
               ...
               'telnet_vtysh': 'EOCU3sTyVGCJRdWvFhPYbN8IgcgGmSMZdf+nN4Khdq0L', \
               'product_code': 'BCM6846', \
               'defa_frn_name': 'Beacon 1.1 (E0-1F-2B-B8-B3-41)', \
               'defa_frn_name_gui': 'APSN9F9A', \
                'udefi_frn_name': 'Beacon 1.1 (E0-1F-2B-B8-B3-41)', \
               'OUI':'089BB9',\
                'Productclass':'Nokia Wifi Beacon 2'}
...
ssh_login={'ipaddresss':'192.168.1.1',\
           ...
           'password':'admin',\
           'password2':'EQJjzWS+Fo/rpQVjleDnTjYCijzLWJ1ev8YLUMHX4BMxQw=='}
ssh_prompt="[root@AONT: admin] "
